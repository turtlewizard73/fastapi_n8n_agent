...
- some vscode settings for convinience

## n8n

Localhosted n8n instance with docker compose.

- [Using custom node with self hosted n8n instance](https://docs.n8n.io/integrations/creating-nodes/deploy/install-private-nodes/#install-your-node-in-a-docker-n8n-instance)
- no need for full Dockerfile, only base image and entrypoint
- commont networking for development convinience
